...
import "github.com/codeminute-the-dev/lattice/node/chaincfg"

// activeNetParams is a pointer to the parameters specific to the
// currently active Lattice network.
...
// reference implementation because latticed does not handle wallet requests.  The
// separate wallet process listens on the well-known port and forwards requests
// it does not handle on to latticed.  This approach allows the wallet process

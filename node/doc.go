...
/*
latticed is a full-node Lattice network implementation written in Go.

The default options are sane for most users.  This means latticed will work 'out of
...
parsed when latticed starts up.  By default, the configuration file is located at
~/.latticed/latticed.conf on POSIX-style operating systems and %LOCALAPPDATA%\latticed\latticed.conf
...
Application Options:
	...
	-d, --debuglevel=           Logging level for all subsystems {trace, debug,
	    ...
	    --miningaddr=           Add the specified payment address to the list of
	                            ...
	                            set
	    --minrelaytxfee=        The minimum transaction fee in LATT/kB to be

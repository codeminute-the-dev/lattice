...
/*
Package btcec implements support for the elliptic curves needed for Lattice.

Lattice uses elliptic curve cryptography using koblitz curves
...
standard formats.  It was designed for use with latticed, but should be

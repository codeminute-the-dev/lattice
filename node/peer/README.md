...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/codeminute-the-dev/lattice/node/peer)

Package peer provides a common base for creating and managing Lattice network
peers.

This package has intentionally been designed so it can be used as a standalone
package for any projects needing a full featured Lattice peer base to build on.

## Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the Lattice wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Lattice peer for handling
...
* [New Outbound Peer Example](https://pkg.go.dev/github.com/codeminute-the-dev/lattice/node/peer#example-package--NewOutboundPeer)  

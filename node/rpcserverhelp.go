...
import (
	...
	"github.com/codeminute-the-dev/lattice/node/btcjson"
)
...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, LATTD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in LATT as the value",
	...
	// EstimateFeeCmd help.
	"estimatefee--synopsis": "Estimate the fee per kilobyte in cells " +
	...
	"estimatefee--result0": "Estimated fee per kilobyte in cells for a block to " +
	...
	// GetNextResetResult help.
	"getnextreset--synopsis":                            "Returns the chain's position in the sawtooth emission schedule and when the block reward next resets to its starting value.",
	"getnextresetresult-height":                         "The current block height",
	"getnextresetresult-epoch":                          "The zero-based emission epoch containing the current height",
	"getnextresetresult-epochblocks":                    "The fixed number of blocks in every emission epoch",
	"getnextresetresult-heightinepoch":                  "The 1-based position of the current height within its epoch",
	"getnextresetresult-epochstartheight":               "The height at which the current epoch began",
	"getnextresetresult-nextresetheight":                "The exact height at which the block reward next resets",
	"getnextresetresult-blocksuntilreset":               "The exact number of blocks remaining until the next reset",
	"getnextresetresult-estimatedsecondsuntilreset":     "Estimated seconds until the next reset, assuming the target block time",
	"getnextresetresult-estimatedresettime":             "Estimated Unix time of the next reset, assuming the target block time",
	"getnextresetresult-blockssincelastreset":           "Blocks mined since the last reset",
	"getnextresetresult-estimatedsecondssincelastreset": "Estimated seconds since the last reset, assuming the target block time",
	"getnextresetresult-currentreward":                  "The block reward at the current height in LATT",
	"getnextresetresult-nextreward":                     "The block reward at the next height in LATT",
	"getnextresetresult-initialreward":                  "The block reward every epoch starts at in LATT",
	"getnextresetresult-mintedthisepoch":                "Supply minted since the last reset in LATT",
	"getnextresetresult-resetthreshold":                 "Per-epoch emission that triggers a reset in LATT",
	"getnextresetresult-totalsupply":                    "Total supply minted through the current height in LATT",
	"getnextresetresult-targetblockseconds":             "The network target block interval in seconds",
	...
	"getblocktemplateresulttx-fee":     "Difference in value between transaction inputs and outputs (in Cell)",
	...
	"getblocktemplateresult-coinbasevalue":              "Total amount available for the coinbase in Cell",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in LATT/KB",
	...
	"infowalletresult-balance":         "The total lattice balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in LATT/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in LATT/KB",
	...
	"getnetworkinforesult-relayfee":           "Minimum relay fee for transactions in LATT/kB",
	"getnetworkinforesult-incrementalfee":     "Minimum fee increment for mempool limiting or BIP 125 replacement in LATT/kB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in lattices",
	...
	"gettxoutresult-value":         "The transaction amount in LATT",
	...
	"searchrawtransactions-address":     "The Lattice address to search for",
	...
	"sendrawtransaction-feesetting":   "Maximum fee rate in LATT/kvB (0 = no limit)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown latticed.",
	"stop--result0":  "The string 'latticed stopping.'",
	...
	"validateaddresschainresult-address":         "The Lattice address (only when isvalid is true)",
	...
	"validateaddress-address":   "Lattice address to validate",

	// VerifyChainCmd help.
	"verifychain--synopsis": "Verifies the block chain database.\n" +
		"The actual checks performed by the checklevel parameter are implementation specific.\n" +
		"For latticed this is:\n" +
	...
	"verifymessage-address":   "The Lattice address to use for the signature",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this latticed instance) and when such a transaction first appears in a newly-attached block.",
	...
	"testmempoolaccept-maxfeerate": "Maximum acceptable fee rate in LATT/kB",
	...
	"testmempoolacceptfees-effective-feerate":  "The effective feerate in LATT per KvB.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getnextreset":           {(*btcjson.GetNextResetResult)(nil)},

...
import (
	...
	"github.com/codeminute-the-dev/lattice/node/blockchain/internal/testhelper"
...
func TestHaveBlock(t *testing.T) {
	...
	t.Skip("Test files rely on Bitcoin block format, which is no longer supported") // TODO Or: re-enable with Lattice-format test fixtures

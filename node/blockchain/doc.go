...
The block handling and chain selection rules are an integral, and quite
likely the most important, part of Lattice.  Unfortunately, at the time of
this writing, these rules are also largely undocumented and had to be
originally derived from Bitcoin Core and btcd.  At its core, Lattice is a

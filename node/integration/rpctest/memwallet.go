...
// SetRPCClient saves the passed rpc connection to latticed as the wallet's
...
// fundTx attempts to fund a transaction sending amt lattices. The coins are
...
// cells-per-byte. The transaction being funded can optionally include a

...
var (
	...
	expectedExternalAddresses = []string{
		"lat1p5cyxnuxmeuwuvkwfem96lqzszd02n6xdcjrs20cac6yqjjwudpxqhjcuq3",
		"lat1p4qhjn9zdvkux4e44uhx8tc55attvtyu358kutcqkudyccelu0wasyz4ak9",
	}
	expectedInternalAddresses = []string{
		"lat1p3qkhfews2uk44qtvauqyr2ttdsw7svhkl9nkm9s9c3x4ax5h60wq0gfgwv",
	}
)

...
[![GoDoc](https://pkg.go.dev/github.com/codeminute-the-dev/lattice/node/database/internal/treap?status.png)](https://pkg.go.dev/github.com/codeminute-the-dev/lattice/node/database/internal/treap)

...
import (
	...
	"github.com/codeminute-the-dev/lattice/node/database/internal/treap"
...
func openDB(dbPath string, network wire.LatticeNet, create bool, flushIntervalSecs uint32) (database.DB, error) {

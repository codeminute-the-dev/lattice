...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.LatticeNet) ([]*btcutil.Block, error) {
...
func TestFailureScenarios(t *testing.T) {
	t.Skip("Skip test since we've changed the Block Header structure") // TODO Or: re-enable with Lattice-format test fixtures

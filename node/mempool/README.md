...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/codeminute-the-dev/lattice/node/mempool)

Package mempool provides a policy-enforced pool of unmined Lattice transactions.

A key responsibility of the Lattice network is mining user-generated transactions
...
Since this package does not deal with other Lattice specifics such as network
...
package for any projects needing the ability create an in-memory pool of Lattice

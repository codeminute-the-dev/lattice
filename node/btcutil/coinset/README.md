...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/codeminute-the-dev/lattice/node/btcutil/coinset)

Package coinset provides Lattice-specific convenience functions for selecting
...
The typical use case for this library is for creating raw Lattice transactions

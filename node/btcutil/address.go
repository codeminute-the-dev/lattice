...
import (
	...
	"github.com/codeminute-the-dev/lattice/node/btcutil/bech32"
	"github.com/codeminute-the-dev/lattice/node/chaincfg"
)

// encodeSegWitAddress creates a bech32m encoded address string from a
// witness version and witness program. Lattice only supports witness versions
...
// output may spend to. All Lattice addresses are witness-based (bech32m).
...
// Lattice only supports witness versions 1+ (bech32m). Version 0 (bech32)
...
// address is the shared implementation for all Lattice address types. Each
...
// (e.g. "lat" for mainnet, "tlat" for testnet).

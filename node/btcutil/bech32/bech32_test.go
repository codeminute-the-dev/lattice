...
func TestBech32DecodeGeneric(t *testing.T) {
	tests := []struct {
		...
		{"LAT1QW508D6QEJXTDG4Y5R3ZARVARY0C5XW7KXLPPWD", Version0},
		{"tlat1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qjuc6tk", Version0},
		{"lat1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7kn7tzfk", VersionM},
		{"LAT1SW50QTZUPDN", VersionM},
		{"lat1zw508d6qejxtdg4y5r3zarvaryvn4j2gc", VersionM},
		{"tlat1qqqqqp399et2xygdj5xreqhjjvcmzhxw4aywxecjdzew6hylgvses72s52v", Version0},
		{"tlat1pqqqqp399et2xygdj5xreqhjjvcmzhxw4aywxecjdzew6hylgvses5asajs", VersionM},
		{"lat1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqrapd2a", VersionM},
	}
	for i, test := range tests {

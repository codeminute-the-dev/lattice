...
func (msg *MsgFilterLoad) LatDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	var err error
	...
	if msg.HashFuncs > MaxFilterLoadHashFuncs {
		...
		return messageError("MsgFilterLoad.LatDecode", str)
	}
...
// This is part of the Message interface implementation.
func (msg *MsgFilterLoad) LatEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	size := len(msg.Filter)
	if size > MaxFilterLoadFilterSize {
		...
		return messageError("MsgFilterLoad.LatEncode", str)
	}

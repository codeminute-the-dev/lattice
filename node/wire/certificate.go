...
Block certificates provide polymorphic proof-of-work verification for the Lattice
...
func (m *MsgCertificate) LatEncode(w io.Writer, pver uint32) error {
...
func (m *MsgCertificate) LatDecode(r io.Reader, pver uint32) error {

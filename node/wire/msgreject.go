...
func (msg *MsgReject) LatDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgReject) LatEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	// Command that was rejected.
	buf := binarySerializer.Borrow()
	defer binarySerializer.Return(buf)

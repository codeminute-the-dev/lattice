...
func (msg *MsgMerkleBlock) LatDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count > maxTxPerBlock {
		...
		return messageError("MsgMerkleBlock.LatDecode", str)
	}
...
// This is part of the Message interface implementation.
func (msg *MsgMerkleBlock) LatEncode(w io.Writer, pver uint32, enc MessageEncoding) error {

...
// LatticeNet represents which network a message belongs to.
type LatticeNet uint32
...
const (
	...
	MainNet LatticeNet = 0x4C41544D // "LATM" in ASCII

	// RegTest represents the regression test network.
	RegTest LatticeNet = 0x4C415452 // "LATR" in ASCII

	// TestNet represents the Lattice test network.
	TestNet LatticeNet = 0x4C415431 // "LAT1" in ASCII

	// TestNet2 represents the Lattice test network v2.
	TestNet2 LatticeNet = 0x4C415432 // "LAT2" in ASCII
	...
	SigNet LatticeNet = 0x40CF030A

	// SimNet represents the simulation test network.
	SimNet LatticeNet = 0x4C415453 // "LATS" in ASCII
)

// netStrings is a map of networks back to their constant names for
// pretty printing.
var netStrings = map[LatticeNet]string{
	MainNet:  "MainNet",
	RegTest:  "RegTest",
	TestNet:  "TestNet",
	TestNet2: "TestNet2",
...
// String returns the LatticeNet in human-readable form.
func (n LatticeNet) String() string {
	if s, ok := netStrings[n]; ok {
		return s
	}

	return fmt.Sprintf("Unknown LatticeNet (%d)", uint32(n))
}

...
func (h *BlockHeader) LatDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
func (h *BlockHeader) LatEncode(w io.Writer, pver uint32, enc MessageEncoding) error {

...
/*
Package addrmgr implements concurrency safe Lattice address manager.

# Address Manager Overview

In order maintain the peer-to-peer Lattice network, there needs to be a source
of addresses to connect to as nodes come and go.  The wire protocol provides

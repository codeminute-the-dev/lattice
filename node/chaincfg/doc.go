...
//
// In addition to the main Lattice network, which is intended for the transfer
...
// wire.LatticeNet using ParamsForNet, but be aware that this usage is
...
//	}
//
// If an application does not use one of the three standard Lattice networks,

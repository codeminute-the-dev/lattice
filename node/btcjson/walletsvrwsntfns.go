...
const (
	...
	// LatticedConnectedNtfnMethod is the method used for notifications when
	// a wallet server is connected to a chain server.
	LatticedConnectedNtfnMethod = "latticedconnected"
...
// LatticedConnectedNtfn defines the latticedconnected JSON-RPC notification.
type LatticedConnectedNtfn struct {
	Connected bool
}

// NewLatticedConnectedNtfn returns a new instance which can be used to issue a
// latticedconnected JSON-RPC notification.
func NewLatticedConnectedNtfn(connected bool) *LatticedConnectedNtfn {
	return &LatticedConnectedNtfn{
		Connected: connected,
	}
}
...
func init() {
	...
	MustRegisterCmd(LatticedConnectedNtfnMethod, (*LatticedConnectedNtfn)(nil), flags)

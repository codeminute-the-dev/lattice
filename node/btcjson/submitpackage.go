...
// response. Values are in LATT. May be omitted if fee info is not applicable.
type JsonSubmitPackageFees struct {
	// Base is the absolute fee of this specific transaction (in LATT).
	Base float64 `json:"base"`

	// EffectiveFeeRate (Optional, LATT/kvB): The transaction's effective

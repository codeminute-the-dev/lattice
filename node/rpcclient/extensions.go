...
//
// NOTE: This is a latticed extension.
...
//
// NOTE: This is an Latwallet extension.
...
// managed by Latwallet are only written to disk with encrypted private keys,
...
func (r FutureGetCurrentNetResult) Receive() (wire.LatticeNet, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	return wire.LatticeNet(net), nil
}
...
//
// NOTE: This is a latticed extension.
func (c *Client) GetCurrentNet() (wire.LatticeNet, error) {
...
// used by Latwallet to enable a wallet which does not have the private keys
...
//
// NOTE: This is a Lattice extension.

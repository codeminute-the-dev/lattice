...
func (c *Client) waitForGetBlockRes(respChan chan *Response, hash string,
	...
	// communicating with a latticed node which only understands the legacy
...
// All supported backends (latticed and compatible forks) use the unified format.
...
// EstimateFee provides an estimated fee in lattices per kilobyte.

...
const parseBech32 = (address: string, options?: Options): AddressInfo => {
  ...
  if (!lowerAddress.startsWith('lat1p') && !lowerAddress.startsWith('tlat1p') && !lowerAddress.startsWith('rlat1p')) {
...
const getAddressInfo = (address: string, options?: Options): AddressInfo => {
  ...
  if (lowerAddress.startsWith('lat1') || lowerAddress.startsWith('tlat1') || lowerAddress.startsWith('rlat1')) {
    try {

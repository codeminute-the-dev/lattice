...
import { Logo, LogoSmall } from '@lattice/ui';
...
const features = [
  ...
  },
  {
    ...
    description: 'Send and receive Lattice with ease',
  },
  {
    icon: BarChart3,
...
export default function WelcomePage() {
  ...
  if (isCheckingWallet) {
    return (
      <div className="flex h-full w-full flex-col items-center justify-center bg-transparent text-gray-900">
        ...
        <h1 className="mb-4 text-2xl font-bold">Lattice Wallet</h1>
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center bg-transparent p-8 text-center text-gray-900">
      ...
      <h1 className="text-4xl font-bold">Lattice Wallet</h1>
      <p className="mt-1 text-gray-600">The official Lattice (LATT) Open Source Desktop Wallet</p>

  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          type="number"
          value={formatLatticeAmount(amount)}
          ...
          step="0.00000001"
          min="0"
          max={formatLatticeAmount(spendableAmount ?? 0)}
        />
      </div>
      {error && (
      ...
      <div className="text-xs text-neutral-500">
        Spendable: {formatLatticeAmount(spendableAmount ?? 0)} LATT (after{' '}
        {formatLatticeAmount(currentFee)} LATT / kb fee reduction)
      </div>

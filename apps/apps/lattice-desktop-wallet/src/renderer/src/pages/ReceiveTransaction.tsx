  ...
  return (
    <div className="flex h-full w-full flex-col bg-transparent">
      ...
      <div className="flex flex-shrink-0 items-center gap-4 border-b border-gray-200 bg-white/80 p-6 shadow-sm backdrop-blur-sm">
        ...
        <h1 className="text-xl font-semibold text-gray-900">Receive Lattice</h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-8 py-12">
        <div className="mx-auto flex max-w-md flex-col items-center">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600">Share this address or QR code to receive Lattice tokens</p>
          </div>
            ...
            <>
              ...
              <div className="border-brand-summer-sky/30 bg-brand-summer-sky/10 mt-4 rounded-lg border p-4">
                <div className="text-sm">
                  <p className="mb-2 font-medium text-gray-900">How to receive Lattice Tokens:</p>

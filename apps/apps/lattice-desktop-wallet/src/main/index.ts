...
log.info('====================================');
log.info('Lattice Desktop Wallet starting...');
...
if (!app.requestSingleInstanceLock()) {
  log.info('Lattice Wallet is already running; exiting this duplicate instance.');
  app.exit(0);
} else {
...
app.whenReady().then(() => {
  electronApp.setAppUserModelId('com.lattice.wallet');

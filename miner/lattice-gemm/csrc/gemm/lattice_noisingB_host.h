...
#include "lattice_noisingB_kernel.h"
...
template <typename ElementDenoise_EARxBpEB, class TileShape_NRK, int kStages,
          bool IsEvenK = false>
void run_lattice_noising_B(LatticeAPIParams const& params,
  ...
  using NoisingKernelB =
      lattice::NoisingKernelB<TileShape_NRK, 128, Element, ElementDenoise,

...
from lattice_gemm_build_utils.generate_instantiations import generate_instantiations
from lattice_gemm_build_utils.write_static_switches import (
    write_matmul_switch,
...
FORCE_BUILD = _env_flag("LATTICE_GEMM_FORCE_BUILD", "TRUE")
SKIP_CUDA_BUILD = _env_flag("LATTICE_GEMM_SKIP_CUDA_BUILD", "FALSE")
# For CI, we want the option to build with C++11 ABI since the nvcr images use C++11 ABI
FORCE_CXX11_ABI = _env_flag("LATTICE_GEMM_FORCE_CXX11_ABI", "FALSE")

DISABLE_SKIP_REDUCTION = _env_flag("LATTICE_GEMM_DISABLE_SKIP_REDUCTION", "FALSE")
DISABLE_SKIP_DENOISING = _env_flag("LATTICE_GEMM_DISABLE_SKIP_DENOISING", "FALSE")
DISABLE_DEBUG_MODE = _env_flag("LATTICE_GEMM_DISABLE_DEBUG_MODE", "FALSE")
DISABLE_R32 = _env_flag("LATTICE_GEMM_DISABLE_R32", "TRUE")
DISABLE_R64 = _env_flag("LATTICE_GEMM_DISABLE_R64", "FALSE")
DISABLE_R128 = _env_flag("LATTICE_GEMM_DISABLE_R128", "FALSE")

SKIP_CPP_GENERATION = _env_flag("LATTICE_GEMM_SKIP_CPP_GENERATION", "FALSE")
...
config_module = importlib.import_module(
    "lattice_gemm_build_utils.kernel_configs.default_compiled_kernels"
)
...
if not SKIP_CUDA_BUILD:
    ...
    warn_if_cuda_home_missing("lattice_gemm")
    ...
    sources = [
        "csrc/gemm/lattice_gemm_api.cpp",

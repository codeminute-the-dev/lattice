...
import torch
from lattice_gemm_cuda import get_build_routing_data_scratchpad_bytes  # noqa: F401
...
def build_routing_data(
    ...
    """
    lattice_gemm_cuda.build_routing_data(
        topk_ids, routing_data, slot_indices, routing_offsets, scratchpad, num_experts
    )


@torch.library.register_fake("lattice_gemm::build_routing_data")

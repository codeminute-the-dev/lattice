...
def denoise_converter(
    ...
    """
    lattice_gemm_cuda.denoise_converter(
        EARxBpEB_in,
        AxEBL_in,
        EARxBpEB_out,
        AxEBL_out,
...
@torch.library.register_fake("lattice_gemm::denoise_converter")
def _abstract_denoise_converter(EARxBpEB_in=None, AxEBL_in=None, EARxBpEB_out=None, AxEBL_out=None):
    return None


# Fake Tensor function for torch.compile support
@torch.library.register_fake("lattice_gemm::noise_gen")
...
# Fake Tensor function for torch.compile support
@torch.library.register_fake("lattice_gemm::noise_A")
...
# Fake Tensor function for torch.compile support
@torch.library.register_fake("lattice_gemm::noise_B")
...
# Fake Tensor function for torch.compile support
@torch.library.register_fake("lattice_gemm::gemm")
def _abstract_gemm(
    A,
    B,
    A_scales,
...
# Fake Tensor function for torch.compile support
@torch.library.register_fake("lattice_gemm::noisy_gemm")
...
def tensor_hash(
    ...
    """
    return lattice_gemm_cuda.tensor_hash(
...
def commitment_hash_from_merkle_roots(
    ...
    *,
    ...
    return lattice_gemm_cuda.commitment_hash_from_merkle_roots(
        A_merkle_root,
        B_merkle_root,
        key,
        A_commitment_hash,
...
@torch.library.register_fake("lattice_gemm::commitment_hash_from_merkle_roots")
...
# Fake Tensor function for torch.compile support
@torch.library.register_fake("lattice_gemm::tensor_hash")

...
from lattice_gateway.comm.dataclasses import BlockTemplate, MiningJob, MiningPausedError
...
class WorkCache:
    ...
    Acts as an in-memory store between the Lattice node and the miner.
    """

...
from lattice_gateway.comm.dataclasses import (
    BlockTemplate,
    MiningJob,
    b64_decode,
    b64_encode,
)
from lattice_gateway.comm.mining_configuration import LatticeMiningConfigurationFactory
from lattice_mining import PENALTY_BASE_RANK
...
class TestAdjustTarget:
    ...
    def test_degenerate_config_is_rejected(self):
        ...
        config = LatticeMiningConfigurationFactory.create(

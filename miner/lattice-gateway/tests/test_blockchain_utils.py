...
from lattice_gateway.blockchain_utils.blockchain_utils import create_coinbase_transaction
...
class TestCreateCoinbaseTransaction:
    ...
    def test_build_coinbase_from_template_matches_node(self):
        ...
        node_mining_address = bech32_encode("tlat", [1] + witness_program_5bit, Encoding.BECH32M)

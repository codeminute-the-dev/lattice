"""
Tests for quantization operators and LatticeKernel mode comparison.
...
# =============================================================================
# LatticeKernel Mode Comparison Tests
# =============================================================================


class DummyLayerWithSmoothScale(torch.nn.Module):
    """Mock layer for testing LatticeKernel."""
...
def async_manager_for_kernel_tests():
    """
    Fixture providing initialized AsyncManager for LatticeKernel tests.
...
class TestLatticeKernelModeComparison:
    ...
    def test_both_modes_produce_correlated_results(self, quant_config):
        ...
        from vllm_miner.vllm_kernels import LatticeKernel

        m, n, k = 512, 1024, 256

        # Create two kernels
        mining_kernel = LatticeKernel(
            quant_config,
            DEFAULT_LAYER_PARAM_NAMES,
            mining_enabled=True,
        )
        non_mining_kernel = LatticeKernel(
            quant_config,
            DEFAULT_LAYER_PARAM_NAMES,

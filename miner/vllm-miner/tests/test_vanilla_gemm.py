...
from vllm_miner.gemm_operators import lattice_gemm_vanilla


@pytest.mark.parametrize("m, n, k", [(1024, 1024, 1024), (8192, 8192, 8192)])
def test_lattice_gemm_vanilla_correctness(make_random_test_matrices, m, n, k):
    """
    Tests that lattice_gemm_vanilla runs without crashing and produces output
    ...
    output = lattice_gemm_vanilla(a, b, scale_a.squeeze(), scale_b.squeeze(), out_dtype)

...
from lattice_gemm import HostSignalStatus, extract_indices, get_host_signal_header
...
class MoEStatusCheckCallback:
    ...
    Headers are acquired from the global pinned pool in ``LatticeMoEExperts.apply``

"""
Lattice quantization scheme for vLLM.
...
Both modes handle smooth_quant_scale through the LatticeKernel.
"""
...
class LatticeScheme(CompressedTensorsScheme):
    """
    Unified scheme for lattice quantization layers.
    ...
    def get_min_capability(cls) -> int:
        return 9  # Hopper and up (required for lattice GEMM)
    ...
    def create_weights(
        ...
        **kwargs,
        ...
        _LOGGER.info(
            f"Using LatticeKernel (mining_enabled={self.mining_enabled}) for {layer_type} layer"
        )
        ...
        if self.is_static_input_scheme:
            ...
            if not self.input_symmetric:
                raise NotImplementedError(
                    "LatticeScheme does not support asymmetric quantization. "

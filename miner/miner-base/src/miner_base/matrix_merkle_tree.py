...
from lattice_mining import MERKLE_LEAF_SIZE, MerkleProof, MerkleTree, pad_to_chunk_boundary
...
class MatrixMerkleTree:
    """
    A Merkle tree built from a 2D int8 tensor using BLAKE3 via lattice_mining.
    """

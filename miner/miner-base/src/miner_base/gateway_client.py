...
from lattice_gateway.comm.json_rpc_client import JSONRPCClient
from lattice_gateway.config import MinerRpcConfig
from lattice_mining import PlainProof
...
class MiningClient(AbstractContextManager):
    ...
    def get_mining_info(self) -> MiningJob:
        """
        Send a getMiningInfo request to the Lattice Gateway.

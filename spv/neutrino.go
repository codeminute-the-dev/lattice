...
import (
	...
	"github.com/codeminute-the-dev/lattice/spv/blockntfns"
	"github.com/codeminute-the-dev/lattice/spv/cache/lru"
	"github.com/codeminute-the-dev/lattice/spv/chanutils"
	"github.com/codeminute-the-dev/lattice/spv/filterdb"
	"github.com/codeminute-the-dev/lattice/spv/headerfs"
	"github.com/codeminute-the-dev/lattice/spv/pushtx"
	"github.com/codeminute-the-dev/lattice/spv/query"
...
func isDevNetwork(net wire.LatticeNet) bool {
...
// This code is identical to latticed's unexported onionAddr. It is used so that

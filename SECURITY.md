...
This policy covers all components in the Lattice monorepo:

- **latticed** — full node (`node/`)
- **Latwallet** — wallet daemon (`wallet/`)
- **SPV client** (`spv/`)
- **ZK proof-of-work** circuits and verifier (`zk-pow/`, `plonky2/`)
- **Mining infrastructure** (`miner/`, `py-lattice-mining/`)
...
should be filed as regular [GitHub issues](https://github.com/codeminute-the-dev/lattice/issues)
instead.

Use [GitHub's private vulnerability reporting](https://github.com/codeminute-the-dev/lattice/security/advisories/new)
...
- **latticed** — full node and protocol (`node/`)
- **ZK proof-of-work** circuits and verifier (`zk-pow/`, `plonky2/`)
- **XMSS** post-quantum signatures (`xmss/`)
- **Latwallet** - wallet daemon (`wallet/`)
- **SPV** - light client (`spv/`)

Reports against other components in the repo (`miner/`, `py-lattice-mining/`,
`dnsseeder/`, `apps/`) are **not bounty-eligible** and should be filed as
regular [GitHub issues](https://github.com/codeminute-the-dev/lattice/issues).
...
- [Report a vulnerability](https://github.com/codeminute-the-dev/lattice/security/advisories/new)

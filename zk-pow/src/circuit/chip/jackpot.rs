...
use crate::circuit::{
    ...
    lattice_stark::LatticeStarkConfig,
...
pub struct JackpotControlFields<V: Copy> {
    ...
    pub jackpot_idx: [V; lattice_columns::JACKPOT_IDX_LEN],
}
...
impl<V: Copy> JackpotControlFields<V> {
    pub(crate) fn consume_fields(row_view: &mut RowView<V>) -> Self {
        ...
        let jackpot_idx = row_view.consume_few(lattice_columns::JACKPOT_IDX_LEN).try_into().unwrap();
...
impl JackpotChip {
        ...
        F: RichField + Extendable<D>,
    {
        ...
        // JACKPOT_MSG
        // BIT_REG
        debug_assert_eq!(row_builder.offset, lattice_columns::CUMSUM_BUFFER);
        row_builder.offset = lattice_columns::BIT_REG_END;
        debug_assert_eq!(row_builder.offset, lattice_columns::BIT_REG_END);
    }

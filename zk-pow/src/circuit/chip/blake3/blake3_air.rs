// Blake3 AIR: Constraint Definitions for Blake3 Compression within the Lattice STARK
// ================================================================================
//
...
// Returns (blake3_output, init_state) where init_state is needed for verify_init_state in lattice_air.
...
// - init_state: for verify_init_state called from lattice_air.
where
    V: Copy,
    S: Copy,
    E: Evaluator<V, S>,

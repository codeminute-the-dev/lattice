...
use crate::{
    ...
    circuit::{
        ...
        lattice_noise::MMSlice,
        lattice_preprocess::{read_dword_from_matrix, read_routing_dword},
    ...
    F: RichField + Extendable<D>,
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Fill MAT_UNPACK
    debug_assert_eq!(row_builder.offset, lattice_columns::MAT_UNPACK);
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::MAT_UNPACK_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Fill UINT8_DATA
    debug_assert_eq!(row_builder.offset, lattice_columns::UINT8_DATA);
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::UINT8_DATA_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Fill NOISE_UNPACK + NOISED_PACKED
    debug_assert_eq!(row_builder.offset, lattice_columns::NOISE_PACKED_PREP);
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::NOISE_UNPACK_END);

    // Fill NOISED_PACKED (2 columns, mat + noise packed with base 256)
    for i in 0..lattice_columns::NOISED_PACKED_LEN {
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::NOISED_PACKED_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // MAT_FREQ
    debug_assert_eq!(row_builder.offset, lattice_columns::MAT_FREQ);
    row_builder.dump_noop(); // To be filled later by frequency computation
    debug_assert_eq!(row_builder.offset, lattice_columns::MAT_FREQ_END);
}

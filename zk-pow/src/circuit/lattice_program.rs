use lattice_blake3::{B3F_CHUNK_END, B3F_CHUNK_START, B3F_KEYED_HASH, B3F_ROOT};
use log::debug;
...
impl CompiledPublicParams {
    /// MoE routing Blake **witness** layout: `num_routing_strips` × 64 bytes (= 8 Lattice dwords each strip).

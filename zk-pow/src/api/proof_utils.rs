...
use crate::circuit::lattice_circuit::LatticeCircuitParams;
use crate::ensure_eq;
...
pub fn compute_hash_activations(
    ...
    let padded = lattice_blake3::pad_to_chunk_boundary(&offsets_bytes);
...
#[cfg(test)]
mod tests {
    use lattice_blake3::BLAKE3_CHUNK_LEN;
    ...
    fn test_periodic_pattern_from_list_to_list_roundtrip() {
        let test_cases: &[&[u32]] = &[
            ...
            &[0, 1, 8, 9, 32, 33, 40, 41, 64, 65, 72, 73, 96, 97, 104, 105], // lattice cols
            &[0, 8],                                                         // simple pair
...
impl PublicProofParams {
    ...
    pub fn public_data_commitment(&self, circuit_params: &LatticeCircuitParams) -> Result<HashOut<GoldilocksField>> {

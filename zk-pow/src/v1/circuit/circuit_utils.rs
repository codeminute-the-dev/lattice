...
use crate::ensure_eq;
use crate::v1::circuit::lattice_circuit::{LatticeCircuitParams, SECURITY_BITS};
...
const CACHE_MAGIC: [u8; 4] = *b"LAT1"; // Lattice Cache Version 1
...
impl CircuitCache {
    ...
    pub(crate) fn make_first_circuit_key(params: LatticeCircuitParams) -> FirstCircuitKey {
        FirstCircuitKey {

...
pub type URange8Chip = RangeTableChip<{ lattice_columns::URANGE8_TABLE }, 0, 255>;
pub type URange13Chip = RangeTableChip<{ lattice_columns::URANGE13_TABLE }, 0, { (1 << BITS_PER_LIMB) - 1 }>;
pub type IRange7P1Chip = RangeTableChip<{ lattice_columns::IRANGE7P1_TABLE }, -64, 64>;
pub type IRange8Chip = RangeTableChip<{ lattice_columns::IRANGE8_TABLE }, -128, 127>;

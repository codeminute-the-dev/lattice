...
impl Blake3Chip {
        ...
        F: RichField + Extendable<D>,
    {
        ...
        // BLAKE3_ROUND
        // CV_OUT
        debug_assert_eq!(row_builder.offset, lattice_columns::BLAKE3_MSG_BUFFER);
        row_builder.offset = lattice_columns::CV_OUT_FREQ_END;
        debug_assert_eq!(row_builder.offset, lattice_columns::CV_OUT_FREQ_END);
    }

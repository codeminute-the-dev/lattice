...
use crate::v1::circuit::{
    ...
    lattice_layout::{BITS_PER_LIMB, BYTES_PER_GOLDILOCKS, lattice_columns},
    lattice_noise::MMSlice,
    lattice_program::{TILE_D, TILE_H},
    lattice_trace::read_tile,
    ...
    F: RichField + Extendable<D>,
{
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::AB_ID_PREP);
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::B_ID_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Fill A_NOISED and A_NOISED_UNPACK
    debug_assert_eq!(row_builder.offset, lattice_columns::A_NOISED);
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::A_NOISED_UNPACK_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Fill B_NOISED and B_NOISED_UNPACK
    debug_assert_eq!(row_builder.offset, lattice_columns::B_NOISED);
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::B_NOISED_UNPACK_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Fill CUMSUM_TILE
    debug_assert_eq!(row_builder.offset, lattice_columns::CUMSUM_TILE);
    ...
    debug_assert_eq!(row_builder.offset, lattice_columns::CUMSUM_TILE_END);
}

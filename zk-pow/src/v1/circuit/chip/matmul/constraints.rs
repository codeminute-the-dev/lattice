...
use crate::v1::circuit::{
    lattice_layout::{BITS_PER_LIMB, BYTES_PER_GOLDILOCKS, lattice_columns, lattice_public},
    lattice_program::{TILE_D, TILE_H},
...
) -> [V; lattice_columns::CUMSUM_TILE_LEN]
where
    V: Copy + Default,
    S: Copy + Default,
    E: Evaluator<V, S>,
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Read A_ID_PREP
    debug_assert_eq!(row_view.offset, lattice_columns::AB_ID_PREP);
    let ab_id_prep = row_view.consume_single();
    let ab_id_limbs = row_view.consume_few(lattice_columns::AB_ID_LIMBS_LEN);
    debug_assert_eq!(lattice_columns::AB_ID_LIMBS_LEN, 4);
    ...
    debug_assert_eq!(row_view.offset, lattice_columns::B_ID_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Read A_NOISED
    debug_assert_eq!(row_view.offset, lattice_columns::A_NOISED);
    let a_noised = row_view.consume_few(lattice_columns::A_NOISED_LEN);
    debug_assert_eq!(row_view.offset, lattice_columns::A_NOISED_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Read A_NOISED_UNPACK
    debug_assert_eq!(row_view.offset, lattice_columns::A_NOISED_UNPACK);
    let a_noised_unpack = row_view.consume_few(lattice_columns::A_NOISED_UNPACK_LEN);
    verify_packing_le(a_noised_unpack, a_noised, c256, eval);
    debug_assert_eq!(row_view.offset, lattice_columns::A_NOISED_UNPACK_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Read B_NOISED
    debug_assert_eq!(row_view.offset, lattice_columns::B_NOISED);
    let b_noised = row_view.consume_few(lattice_columns::B_NOISED_LEN);
    debug_assert_eq!(row_view.offset, lattice_columns::B_NOISED_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Read B_NOISED_UNPACK
    debug_assert_eq!(row_view.offset, lattice_columns::B_NOISED_UNPACK);
    let b_noised_unpack = row_view.consume_few(lattice_columns::B_NOISED_UNPACK_LEN);
    verify_packing_le(b_noised_unpack, b_noised, c256, eval);
    debug_assert_eq!(row_view.offset, lattice_columns::B_NOISED_UNPACK_END);

    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Read CUMSUM_TILE
    debug_assert_eq!(row_view.offset, lattice_columns::CUMSUM_TILE);
    let cumsum_tile = row_view.consume_few(lattice_columns::CUMSUM_TILE_LEN);
    let next_cumsum_tile = &next_trace[lattice_columns::CUMSUM_TILE_RANGE];
    let next_a_noised_unpack = &next_trace[lattice_columns::A_NOISED_UNPACK_RANGE];
    let next_b_noised_unpack = &next_trace[lattice_columns::B_NOISED_UNPACK_RANGE];
    let next_is_reset_cumsum = next_trace[lattice_columns::IS_RESET_CUMSUM];
    let next_is_update_cumsum = next_trace[lattice_columns::IS_UPDATE_CUMSUM];
    ...
    debug_assert_eq!(row_view.offset, lattice_columns::CUMSUM_TILE_END);

...
impl I8U8Chip {
        ...
        F: RichField + Extendable<D>,
    {
        ...
        debug_assert_eq!(row_builder.offset, lattice_columns::I8U8_FREQ_END);
    }
        ...
        E: Evaluator<V, S>,
    {
        ...
        debug_assert_eq!(row_view.offset, lattice_columns::I8U8_TABLE);
        let i8u8 = row_view.consume_single();
        let i8u8_aux = row_view.consume_single();
        let _freq = row_view.consume_single(); // skip FREQ column
        let next_i8u8 = next_trace[lattice_columns::I8U8_TABLE];
        let next_i8u8_aux = next_trace[lattice_columns::I8U8_AUX];
        ...
        debug_assert_eq!(row_view.offset, lattice_columns::I8U8_FREQ_END);
    }
}

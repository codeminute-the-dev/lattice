...
use crate::v1::circuit::lattice_air::eval_constraints;
use crate::v1::circuit::lattice_layout::{lattice_columns, lattice_public};
use crate::v1::circuit::lattice_preprocess::generate_preprocessed;
use crate::v1::circuit::lattice_program::{RowLogic, TILE_D, TILE_H};
use crate::v1::circuit::lattice_trace::generate_trace;
    ...
    fn lookups(&self) -> Vec<Lookup<F>> {
        ...
        let mut lookup_data = vec![
            ...
            unfiltered_lookup(
                ...
                Column::<F>::singles(lattice_columns::MAT_ID_LIMBS_RANGE.chain(lattice_columns::AB_ID_LIMBS_RANGE)).collect(),
            ),
            // Signal is in [-64, 64].
            unfiltered_lookup(
            ...
            Lookup {
                ...
                filter_columns: vec![
                    Filter::<F>::from_column(Column::<F>::single(lattice_columns::IS_MSG_MAT));
        ...
        for i in 0..lattice_columns::CV_OUT_LEN {
            lookup_data.push(Lookup {
                ...
                table_column: indexed_column::<F>(lattice_columns::CV_OUT + i, lattice_columns::STARK_ROW_IDX, 1u64 << 32, 0),

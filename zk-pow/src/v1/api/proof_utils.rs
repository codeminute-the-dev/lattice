...
use crate::v1::circuit::lattice_circuit::LatticeCircuitParams;
...
impl PublicProofParams {
    ...
    pub fn public_data_commitment(&self, circuit_params: &LatticeCircuitParams) -> HashOut<GoldilocksField> {

...
use lattice_blake3::BLAKE3_DIGEST_SIZE;
...
fn compute_external_cvs(
    ...
    let a_ranges = p.a.proof.compute_sibling_ranges(lattice_blake3::padded_chunk_len(m * k));
    let b_ranges = p.bt.proof.compute_sibling_ranges(lattice_blake3::padded_chunk_len(n * k));

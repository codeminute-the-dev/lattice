//! Unified Python module for Lattice mining.
//!
//! Registers types from lattice-blake3 and zk-pow into a single Python module.
...
use lattice_blake3::{pad_to_chunk_boundary, MerkleProof, MerkleTree};
...
use zk_pow::circuit::lattice_circuit::{LatticeRecursion, RecursionCircuit};
...
type CircuitCache = <LatticeRecursion as RecursionCircuit>::CircuitCache;
...
#[pymodule]
fn lattice_mining(m: &Bound<'_, pyo3::types::PyModule>) -> PyResult<()> {

...
Python library for Lattice proof-of-work ZK proof generation/verification.
Imports as `lattice_mining`.
...
```python
from lattice_mining import IncompleteBlockHeader, verify_plain_proof_for_cert_version
...
```python
from lattice_mining import generate_proof_for_cert_version
...
```python
from lattice_mining import verify_proof_for_cert_version
...
```
ZKCertificate.serialize() | LatticeHeader.serialize() | TX_COUNT (varint) | TRANSACTIONS
```

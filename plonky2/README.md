# Plonky2 & more (Lattice Fork)

This is the Lattice fork of Plonky2, a SNARK implementation based on techniques from PLONK and FRI. It has since expanded to include tools such as Starky, a highly performant STARK implementation.

> **Note:** This fork is maintained by the Lattice Team. The upstream Plonky2 project by Polygon Zero has been deprecated in favor of [Plonky3](https://github.com/Plonky3/Plonky3). This Lattice fork continues to be actively maintained and developed.

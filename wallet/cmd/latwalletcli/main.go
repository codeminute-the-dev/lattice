...
// latwalletcli is an interactive terminal client for the latwallet wallet daemon.
...
func run() error {
	...
	// latwallet.conf), write a secure config ourselves rather than asking the
...
func printBanner(cfg *config) {
	banner := th.title.Render("latwallet wallet") +

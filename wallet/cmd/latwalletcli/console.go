...
// transport used here (mirrors latctl).
...
// autocompletion. Unknown methods are still sent verbatim: latwallet forwards
// anything it does not handle to latticed, so node RPCs work here too.

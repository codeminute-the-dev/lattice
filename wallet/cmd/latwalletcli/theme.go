...
// latwalletTheme is huh's stock charm theme with one workaround: menu option
...
// latwalletKeyMap extends huh's defaults so Esc aborts any form (the default
...
// visible per field.
func latwalletKeyMap() *huh.KeyMap {

...
var (
	...
	testCases = []*testCase{{
		...
		expectedAddr:       "tlat1pmxa4c2w8cp6dq0j65sm4ha5qglr83xuwqhjlnzgr9etj8l9n5rrq3whk5m",
		expectedChangeAddr: "tlat1p23muxzw30p5gvc8sthgkfckcqzxnf5rzpvak6zl9x0gjeqnxgu0qsqxlcs",
	}, {
		...
		addrType:           waddrmgr.TaprootPubKey,
		expectedScope:      waddrmgr.KeyScopeBIP0086,
		expectedAddr:       "tlat1pqquds2zajq7s32crdmqd6v2xkgl57mr2wftwq35zm77nepn2mexs4vacul",
		expectedChangeAddr: "tlat1p9sk7jvzr2heekznre0jjgzvyepzlz5cw8uydacthu8zp2fdny2tqsgluz0",
	}}
)

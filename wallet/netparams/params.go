...
// MainNetParams contains parameters specific running Latwallet and
// latticed on the main network (wire.MainNet).
...
// TestNetParams contains parameters specific running Latwallet and
// latticed on the test network (wire.TestNet).
...
// TestNet2Params contains parameters specific running Latwallet and
// latticed on the test network v2 (wire.TestNet2).
...
func SigNetWire(params *chaincfg.Params) wire.LatticeNet {

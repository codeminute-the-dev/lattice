...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in LATT",
	"getbalance--result1":    "The balance of all accounts valued in LATT",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in LATT",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in LATT",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in LATT",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and LATT amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in LATT",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in LATT",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in LATT",
	...
	"listtransactionsresult-amount":             "The value of the transaction output valued in LATT",
	...
	"listunspentresult-amount":        "The amount of the output valued in LATT",
	...
	"sendfrom-amount":       "Amount to send to the payment address valued in LATT",
	"sendfrom-feerateperkb": "Fee rate in LATT per kilobyte for the transaction",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in LATT to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in LATT",
	"sendmany-feerateperkb":   "Fee rate in LATT per kilobyte for the transaction",
	...
	"sendtoaddress-amount":       "Amount to send to the payment address valued in LATT",
	"sendtoaddress-feerateperkb": "Fee rate in LATT per kilobyte for the transaction",
	...
	"settxfee-amount":    "The new fee increment valued in LATT",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in LATT.",

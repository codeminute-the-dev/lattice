...
import (
	...
	"github.com/codeminute-the-dev/lattice/wallet/rpc/legacyrpc"
...
// startChainRPC opens a RPC client connection to a latticed server for blockchain
...
func startChainRPC(certs []byte) (*chain.RPCClient, error) {
	...
	rpcc, err := chain.NewRPCClient(activeNet.Params, cfg.RPCConnect,
		cfg.LatticedUsername, cfg.LatticedPassword, certs, cfg.DisableClientTLS, 0)
	if err != nil {
		return nil, err
	}

...
import (
	...
	"github.com/codeminute-the-dev/lattice/wallet/snacl"
...
func testImportPrivateKey(tc *testContext) bool {
	tests := []struct {
	...
	}{
		{
			...
			expected: expectedAddr{
				address:     "lat1pdj78vjhv4wukfzfu3qyvwclcewrsyfq8fyx2gvs8s850smsgw0yqx0rk94",
...
func testImportScript(tc *testContext) bool {
	tests := []struct {
	...
	}{
		{
			...
			expected: expectedAddr{
				address:     "lat1pu92qt24cl4spyp4rsj9sa3y4ma6a3fszgewcmway9f6f80vgnduq45xjhw",

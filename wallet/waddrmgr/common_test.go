...
import (
	...
	_ "github.com/codeminute-the-dev/lattice/wallet/walletdb/bdb"
)
...
var (
	...
	expectedAddrs = []expectedAddr{
		{
			address:     "lat1psayn40fkp3f3szxztahxwszhyjfxe3u9tqxycujd6q2zcw4uc99szxrmam",
		...
		{
			address:     "lat1pvdtcl546a64kk9p06nc75vrwlqfrl3m9myhl07wd69zvfma6fq3qu9djvl",
		...
		{
			address:     "lat1penz3j6q2rvnh02axv4ysxp6z789qtteezuq0jnm2nr5w562uaywqczay0g",
		...
		{
			address:     "lat1pdl6palz9pxn5zdufcx9wguuz95wruwwu2awmdkpjf5p2lvdk2snsevkr5v",
		...
		{
			address:     "lat1p0qmn60e5r5y55ztcna3p7vnwdq5c2pp4xa69a0e7gxt5vvr5mspqumv5ud",
		...
		{
			address:     "lat1pya7e4s6kl2tpf5awz34687j6cngw0lgrqd3qq927w2qzusxmgcgsvuar6a",
		...
		{
			address:     "lat1pen8y8ph9jtqzn885qv4tlczmf5kg6k9cc53kkevu3wxenaq6zy0qfzrrkj",
		...
		{
			address:     "lat1pqz2jravv8q56wx2rpu8u84sdug5rah7rkt8dzqdvdndpclza0yssqmp2he",
		...
		{
			address:     "lat1pdcl4mszx3c44ywv75ff4nhk6mnvnt9gu298reyqk70p6murvvagsan8tfq",
		...
		{
			address:     "lat1plv3kmy9z60d7etcmwapjjfk0g0ahy8m9llt35pucs3zjdpkvffmqpsrgcx",
